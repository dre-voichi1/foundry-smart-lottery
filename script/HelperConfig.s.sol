...
contract HelperConfig is Script, CodeConstants {
    ...
    function getConfig() public returns (NetworkConfig memory networkConfig) {
        ...
        returns (NetworkConfig memory)
    {
        ...
        localNetworkConfig = NetworkConfig({
            ...
            vrfCoordinator: address(vrfCoordinator), // Mock VRF Coordinator address
            gasLane: 0x787d74caea10b2b357790d5b5247c2f63d1d91572a9846f780606e4d953677ae, // gasLane doesn't really matter in here
            callbackGasLimit: 500000,
            subscriptionId: 0,
            link: address(linkToken) // Address of the mock LINK contract
        });
    ...
    function getSepoliaEthConfig() public pure returns (NetworkConfig memory) {
        return
            NetworkConfig({
                ...
                link: 0x779877A7B0D9E8603169DdbD7836e478b4624789 // LINK token address in Sepolia
            });
    }
}
